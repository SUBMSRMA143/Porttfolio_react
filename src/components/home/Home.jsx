...
const Home = () => {
    return (
        <div id="1" className="relative w-[100vw] flex justify-center items-center">
            ...
            <div className="text-center pt-10 max-[500px]:pt-[100px] flex flex-col gap-5 my-[16%] justify-center items-center">
                <p className="text-xl">Hi, I'm</p>
                <h1 className="w-[100%] text-blue-100 text-6xl max-[500px]:text-4xl">Shubham Parashar</h1>
                <h3 className="w-[100%] text-blue-500 text-3xl max-[500px]:text-xl">FrontEnd Web-developer</h3>
                <a href="#2"
