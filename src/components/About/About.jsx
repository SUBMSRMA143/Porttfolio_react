...
const About = () => {
    return (
        <div id="2" className="bg-black w-[100vw] h-[100%] pt-[50px]">
            <div
                className="h-[70%] try w-[100%] backdrop-blur absolute z-[2] flex items-center p-5 px-[100px] pl-[150px] border-y-2 border-gray-600">
                <img src={me} alt="picture"
                    className="rounded-full object-cover bg-[left_1rem] w-[700px] h-[400px]" />
                <div className="w-[100%] px-[100px] flex flex-col py-5 gap-5 items-center">
